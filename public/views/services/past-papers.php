    ...
    <main class="bgColor-1 w-11/12 lg:w-10/12 h-56 m-0-auto mt-5 ff-pri">
        ...
        <div class="w-full pt-1 lg:pt-4 pb-2 lg:pb-5 lg:fx fx-j-a">
            <div class="w-full lg:w-9/12 ">
                <input id="keyword" class="bgColor-sec-100 w-full py-2 lg:py-4 px-2 rounded
                border b-color-sec-100 focus:bgColor-1 outline-0"
                type="text" name="keyword" placeholder="Search past papers ..."
                onkeyup="(new Ajax).route('search-paper')
        ...
        <input type="hidden" id="doc_type" value="paper">

        <div id="doc_list" class="w-full fx fx-wrap  fx-a-i fx-j-c">

            <?php require_once view("services/partials/papers"); ?>
