...
<body>
    ...
    <main class="bgColor-1 w-11/12 lg:w-10/12 h-56 m-0-auto mt-2 ff-pri">
        <div class="w-full lg:w-11/12 m-0-auto lg:fx fx-j-a fx-i-c py-4">
            ...
            <h4 class="pb-2 lg:pb-0"><?= $pdf->title ?></h4>

                <a href="/public/assets/images/pdfs/docs/<?= $pdf->document ?>"
                    data-action-type='download' download='<?= $pdf->title ?>'>
        ...
        function download() {
          var  href = 'http://localhost:8000/public/assets/images/pdfs/docs/6044e8c3b1a49.pdf';
        ...
        <script type="text/javascript">
            ...
            document.addEventListener("adobe_dc_view_sdk.ready", function()
            {
                ...
                adobeDCView.previewFile({
                    content:{location: {url: "/public/assets/images/pdfs/docs/<?= $pdf->document ?>"}},
                    metaData:{fileName: "<?= $pdf->title ?>"}
                }, {});
            });
